...
var CMapModel = widgets.WidgetModel.extend({
    defaults: function() {
        return _.extend(widgets.WidgetModel.prototype.defaults.call(
            this), {
    ...
    normalize: function() {
        return _yt_tools.then(function(yt_tools) {
            ...
            colormaps.normalize(this.map_name, this
                .data_array, this.image_array, this
                .min_val, this.max_val, this.is_log);
